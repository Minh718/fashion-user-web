...
const UserChatbox: React.FC = () => {
  ...
  const [infoChatBox, setInfoChatBox] = useState<InfoChatBox | null>(null);
  ...
  const sendPrivateMessage = () => {
    if (privateStompClient && isAuthenticated && infoChatBox && userInfo) {
